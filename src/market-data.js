window.MILLENIA_MARKET = {
  ...
  points: [
    ...
    { layer: "hca", name: "HCA Florida West Orange Emergency", system: "HCA Florida", category: "Sister FSED", address: "1320 Daniels Rd, Winter Garden, FL 34787", coords: [28.5484, -81.5862], priority: "Network", notes: "Address updated from current HCA/Google listing." },
    ...
    { layer: "ocfr", name: "OCFR Station 50 - Engine 50", system: "Orange County Fire Rescue", category: "EMS Station", address: "1415 29th St, Orlando, FL 32805", coords: [28.5131, -81.3983], priority: "Core", notes: "Central-West Orlando. High urban EMS activity." },
    ...
    { layer: "ocfr", name: "OCFR Station 52 - Engine 52", system: "Orange County Fire Rescue", category: "EMS Station", address: "4765 W Sand Lake Rd, Orlando, FL 32819", coords: [28.4508, -81.4443], priority: "Tourism", notes: "Dr. Phillips / Sand Lake. Heavy visitor traffic area." },
    ...
    { layer: "ocfr", name: "OCFR Station 70 - Engine 70", system: "Orange County Fire Rescue", category: "EMS Station", address: "1027 E Wallace St, Orlando, FL 32809", coords: [28.4484, -81.3638], priority: "South Orlando", notes: "Corrected from the I-Drive address in the source CSV." },
    ...
    { layer: "ocfr", name: "OCFR Station 72 - Engine 72", system: "Orange County Fire Rescue", category: "EMS Station", address: "3705 Conway Rd, Orlando, FL 32812", coords: [28.5070, -81.3301], priority: "Residential", notes: "Conway / SoDo. High residential EMS activity." },
    { layer: "ocfr", name: "OCFR Station 31 - Engine 100", system: "Orange County Fire Rescue", category: "EMS Station", address: "6116 S Apopka Vineland Rd, Orlando, FL 32819", coords: [28.4648, -81.5054], priority: "West tourism", notes: "Universal / I-Drive west. Official station listing shows Quint 31 and Engine 100." },
    ...
    { layer: "ofr", name: "Orlando Fire Station 3", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "2406 N Elizabeth Ave, Orlando, FL 32804", coords: [28.57321, -81.38512], priority: "College Park", notes: "Address updated from City of Orlando Fire Station 3 listing." },
    ...
    { layer: "ofr", name: "Orlando Fire Station 6", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "3113 E Robinson St, Orlando, FL 32803", coords: [28.5455, -81.3446], priority: "East city", notes: "Address updated from City of Orlando/local firefighter station directory." },
    ...
    { layer: "ofr", name: "Orlando Fire Station 8", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "6651 S Shoalcreek Dr, Orlando, FL 32812", coords: [28.4670079, -81.3178877], priority: "Airport west", notes: "Address and coordinates updated from City of Orlando Fire Station 8 listing." },
    { layer: "ofr", name: "Orlando Fire Station 10", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "5655 W Vineland Rd, Orlando, FL 32819", coords: [28.4852, -81.4568], priority: "Universal / Kirkman", notes: "Address updated from City of Orlando/local firefighter station directory." },
    { layer: "ofr", name: "Orlando Fire Station 11", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "4911 Curry Ford Rd, Orlando, FL 32812", coords: [28.5229, -81.3251], priority: "East city", notes: "Address updated from City of Orlando/local firefighter station directory." },
    { layer: "ofr", name: "Orlando Fire Station 12", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "1588 Park Center Dr, Orlando, FL 32835", coords: [28.5228, -81.4738], priority: "MetroWest", notes: "Address updated from City of Orlando/local firefighter station directory." },
    { layer: "ofr", name: "Orlando Fire Station 14", system: "Orlando Fire Rescue", category: "Fire/EMS Station", address: "5450 S Econlockhatchee Trl, Orlando, FL 32829", coords: [28.4831, -81.2496], priority: "Southeast city", notes: "Address updated from City of Orlando Fire Station 14 listing." }
  ],
  routes: [
